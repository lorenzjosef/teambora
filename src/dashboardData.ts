...
export const activityDemand: {
  ...
  { id: "hackathons", label: "Hackathons", acceptedSuggestions: 22, unmetDemand: 15, frictionNote: "Mentor tables fill quickly" },
  { id: "basketball", label: "Basketball", acceptedSuggestions: 20, unmetDemand: 18, frictionNote: "Public courts overbooked after school" },
  { id: "board_games", label: "Board games", acceptedSuggestions: 19, unmetDemand: 9, frictionNote: "Venue tables are the bottleneck" },
  { id: "fencing", label: "Fencing", acceptedSuggestions: 16, unmetDemand: 10, frictionNote: "Beginner lesson slots are scarce" },
